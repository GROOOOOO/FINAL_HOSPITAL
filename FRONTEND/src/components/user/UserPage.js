    ...
    return (
        <div className="crud">
            ...
            <main className="crud-body">
                <h2 style={{ color: 'green', fontWeight: 'bold' }}>Doctor Management</h2>
                    ...
                    <tbody>
                        {doctors.map((doctor) => (
                            <tr key={doctor.id}>
                                ...
                                <td>
                                    <button className="btn btn-secondary mr-2" onClick={() => openViewDoctor(doctor)} type="button">
                                        View
                                    </button>
                                    <button className="btn btn-success" onClick={() => openNewAppointmentModal(doctor)} type="button">
                ...
                <div className="modal show d-block" tabIndex="-1" role="dialog">
                    <form onSubmit={submitNewAppointment}>
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" style={{ color: 'green', fontWeight: 'bold' }}>Schedule New Appointment</h5>
                                    <button type="button" className="close" onClick={handleCloseModal} aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div className="modal-body">
                                    <div className="form-group">
                                        <label style={{ color: 'green', fontWeight: 'bold' }}>Appointment Date:</label>
