...
import Homepagereceptionist from './ReceptioHome';
    ...
    return (
        <div className="crud">
            ...
            <main className="crud-body">
                ...
                <button className="btn btn-success mb-3" onClick={openAddPatientModal}>Add Patient</button>
                    ...
                    <div className="modal show d-block" tabIndex="-1" role="dialog">
                        <form onSubmit={submitNewPatient}>
                            <div className="modal-dialog" role="document">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h1 style={{ color: 'green', fontWeight: 'bold' }} >Add New Patients</h1>
